...
//	public final PDPage page ; 
	 ...
	 * Height of PDF-Box page. 
	 * <p>
	 * The left and right BlockFrame page margins are contained in this height. 
	 */
...
//	 * This is usually managed for you in the top level {@link PdfChapter} and similar classes. 
//	 */
//	Canvas(PDDocument document, PDPage page, double pageHeight, double pageWidth) throws IOException { 
////		this.page = page ; 
