...
public class Layout implements Verbosity { 
	...
	public static final Justification CENTRE_H = new Justification("centre_h"); 
	...
	public Layout setLeft() { this.justification = LEFT ; return this ; } 
	...
	public Layout setTop() { this.alignment = TOP ; return this ; } 
	...
	Layout copyAndSetSize(PDPage page) { 
		// WARNING 6mar18: This is not aware of rotations. 
		Layout layout = new Layout(this); 
	...
	public static double getJustificationSpace(Justification justification, double spareSpace) {
		double justificationSpace ;
		if (justification==CENTRE_H) { 
			justificationSpace = spareSpace * 0.5 ; 
		} else if (justification==RIGHT) { 
			justificationSpace = spareSpace ; 
		} else { 
			justificationSpace = 0 ; 
		}
		return justificationSpace ;
	}
	
	public static double getAlignmentSpace(Alignment alignment, double spareHeight) {
		double justificationSpace ;
		if (alignment==CENTRE_V) { 
			justificationSpace = spareHeight * 0.5 ; 
		} else if (alignment==BOTTOM) { 
			justificationSpace = spareHeight ; 
		} else { 
			justificationSpace = 0 ; 
		}
		return justificationSpace ;
