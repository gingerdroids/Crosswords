 ...
 * <p>
 * By convention here, methods which trace a complete path - a closed path including the initial {@link PDPageContentStream#moveTo(float, float)} call - 
 * are called <code>traceXxxx</code>. 
